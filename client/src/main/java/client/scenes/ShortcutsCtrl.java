...
public class ShortcutsCtrl implements Initializable {
    ...
    @FXML
    private TableColumn<Shortcut, String> actionColumn, pageColumn, shortcut1Column, shortcut2Column;
    ...
    private void updateTableItems() {
        ...
        addShortcut("go.back", "any.page", "shortcut.alt.left.arrow", "shortcut.mouse.button4");
        ...
        addShortcut("show.settings", "any.page", "shortcut.alt.f.alt.s", "");
    }

    private void addShortcut(String actionKey, String pageKey, String shortcut1Key, String shortcut2Key) {
        shortcutsTable.getItems().add(new Shortcut(i18nService.get(actionKey), i18nService.get(pageKey), i18nService.get(shortcut1Key), i18nService.get(shortcut2Key)));
    }
    ...
    public static class Shortcut {
        ...
        public Shortcut(String action, String page, String shortcut1, String shortcut2) {
