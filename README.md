...
An expense management app that can be used to create and join events and manage expenses.
...
This is the backlog we followed: [Backlog](docs/project%20docs/oopp24-splitty-backlog.pdf)
...
To see this in action, open 2 clients, and when you modify something on one of the clients, you will see the changes on the other client in real time.
...
- event
  - allow bigger description & title
- home
...
Reversed chronological order. Planned time -> actual time
